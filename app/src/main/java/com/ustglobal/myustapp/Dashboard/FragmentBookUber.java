...
// */
//
//public class FragmentBookUber extends Fragment implements RideRequestButtonCallback, OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
//
...
//
//
//    public FragmentBookUber(Activity act) {
//        this.act = act;
//    }
//
//
...
//        rootView = inflater.inflate(R.layout.fragment_book_uber, container, false);
//        init();
//        setDimension();
//
...
//
//        txt_where = (TextView) rootView.findViewById(R.id.txt_where);
//        blackButton = (RideRequestButton) rootView.findViewById(R.id.uber_button_black);
//
//
//
//
...
////        RideRequestActivityBehavior rideRequestActivityBehavior = new RideRequestActivityBehavior(getActivity(), WIDGET_REQUEST_CODE, configuration);
...
//                Toast.makeText(getActivity(), "Auth error " + error.name(), Toast.LENGTH_SHORT).show();
...
//                        .RIDE_REQUEST_ERROR);
//                Toast.makeText(getActivity(), "RideRequest error " + error.name(), Toast.LENGTH_SHORT).show();
