...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.ViewHolderNew> {
    private static LayoutInflater inflater = null;
    private Activity act;
    EventsHorizontalAdapter adapter;
    private ViewHolderNew holder;
    private ArrayList<BlogsOBJ> blogs;
    private Map<String, ArrayList<SubCategoryOBJ>> sub_events;
    private HashMap<String, ArrayList<EventsOBJ>> events;


    public HomeAdapter(Activity act, ArrayList<BlogsOBJ> blogs, Map<String, ArrayList<SubCategoryOBJ>> sub_events) {
        this.act = act;
        this.blogs = blogs;
    ...
    public void onBindViewHolder(ViewHolderNew holder, final int position) {
        ...
        final BlogsOBJ obj = blogs.get(position);
        holder.txt_type.setText(obj.getSuperCategory());

        final ArrayList<SubCategoryOBJ> sub_obj = sub_events.get(obj.getSuperCategory());

        final JSONArray sub_arr = sub_obj.get(0).getSubCatgData();
        ...
        holder.txt_found.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(act, SubCategoryList.class);
                String str = obj.getSuperCategory();
                in.putExtra("obj", str);
