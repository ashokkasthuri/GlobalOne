...
public class FragmentProfile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        sp = new USTSharedPreferences(getActivity());
        init();
        setDimension();
    ...
    private void setDimension() {
        ...
        btn_change.getLayoutParams().height = (int) (height * 0.08);
        btn_change.getLayoutParams().width = (int) (width * 0.8);
    ...
    private void login() {
        ...
        WebAuthProvider.init(auth0)
                .withScheme("demo")
                .start(getActivity(), new AuthCallback() {
                    @Override
    ...
    private void getUserData() {
        ...
        authenticationClient.userInfo(CredentialsManager.getCredentials(getActivity()).getAccessToken()).start(new BaseCallback<UserProfile, AuthenticationException>() {
    ...
    private void loginAgain() {
        CredentialsManager.deleteCredentials(getActivity());
